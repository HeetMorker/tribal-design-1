                ...
                <div class="row tri">
                    <div class="slider-content">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.php">Tree Planting</a></h5>
                                <p>Our tribal welfare community actively participates in tree planting initiatives
                                    to preserve and enhance the environment for future generations.</p>
                            </div>
                        </div>
                    </div>
                    <div class="slider-content">
                        <div class="single-cat   text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.php">Fertilizer and Seed Kits</a></h5>
                    ...
                    <div class="slider-content">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.php">Blood Donation Camp</a></h5>
                                <p>Our blood donation camps aim to address blood shortages and save lives by encouraging voluntary blood donations from community members.</p>
                            </div>
                        </div>
                    </div>
                    <div class="slider-content">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.php">Pulse Examination</a></h5>
                                <p>We conduct pulse examination camps to monitor and promote cardiovascular health among individuals in our community, facilitating early detection of potential health issues.</p>
                            </div>
                        </div>
                    </div>
                    <div class="slider-content">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.php">Computer Training</a></h5>
                                <p>Our computer training programs equip community members with essential digital skills, empowering them to access educational and employment opportunities in the digital age.</p>
                            </div>
                        </div>
                    </div>
                    <div class="slider-content">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.php">Distribution of Cows</a></h5>
                                <p>We support sustainable livelihoods by distributing cows to deserving families, enabling them to generate income through dairy farming and improve their economic prospects.</p>
                            </div>
                        </div>
                    </div>
                </div>
