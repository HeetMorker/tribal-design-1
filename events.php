                ...
                <div class="col-12">
                    ...
                    <section class="hero is-light is-medium bg-transparent">
                        <div class="hero-foot mb-5 position-relative" style="overflow-x: hidden;">
                            ...
                            <ul id="buttonGroup" class="d-inline-flex">
                                ...
                                <li class=" "><button class="btn mas-btn"> <a class="" id="blood_donation">Blood
                                            Donation</a></button></li>
                                <li class=" "><button class="btn mas-btn"> <a class="" id="yoga">Yoga
                                            Training</a></button></li>
                                <li class=""><button class="btn mas-btn"> <a class="" id="employment">Employment
                                            Guidance</a></button></li>
                                <li class=" "><button class="btn mas-btn"> <a class=""
                                            id="deadd">De-Addiction</a></button></li>
                                <li class=" "><button class="btn mas-btn"> <a class="" id="organic">Organic
                                            Farming</a></button></li>
                                <li class=" "><button class="btn mas-btn"> <a class="" id="cow">Cow
                                            Donation</a></button></li>
                        ...
                        <div class="grid" id="container">
                            ...
                            <div class="grid-item employment"><img src="assets/img/employee guidance/eg2.jpg" alt="" />
                            </div>
                            <div class="grid-item deadd "><img src="assets/img/De addication/8.jpeg" alt="" /></div>
                            <div class="grid-item employment"><img src="assets/img/employee guidance/eg3.jpg" alt="" />
                            </div>
                            <div class="grid-item blood_donation"><img
                                    src="assets/img/blood donation/blood_donation1.jpg" alt="" /></div>
                            <div class="grid-item yoga"><img src="assets/img/yoga/4.jpg" alt="" /></div>
                            <div class="grid-item employment"><img src="assets/img/employee guidance/eg4.jpg" alt="" />
                            </div>
                            ...
                            <div class="grid-item organic"><img src="assets/img/organic farming/fer2.jpg" alt="" />
                            </div>
                            ...
                            <div class="grid-item fest">
                                <div class="cases-img">
                                    <a data-fancybox data-width="940" data-height="660"
                                        href="assets/img/adivasi festival/vid4.mp4"><i class="fa-solid fa-play"></i></a>
                                    <video height="300">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    tabsUl.addEventListener('click', (event) => {
        if (event.target.tagName === 'BUTTON' || event.target.tagName === 'A') {
            const button = event.target.tagName === 'BUTTON' ? event.target : event.target.closest(
                'button');
            const tabId = button.querySelector('a').id;
...
document.getElementById("rightArrow").addEventListener("click", function() {
    if (translateX != -600) {
        ...
        document.getElementById("buttonGroup").style.transform = "translateX(" + translateX + "px)";
    }
